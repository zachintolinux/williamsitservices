...
<a href="williamscomputersales.html"><img class="center-text topbar" src="logo-via-logohub.png" width="304" height="31" alt="logo"></a>
    <h3 class="center-text font">Complete Inventory</h3>
    <div class="center-text font">
        <?php
        include 'db.php';
        ...
        while ($result_ar = mysqli_fetch_assoc($result)) {
            ...
            echo "<td>";
            echo '$' . number_format($result_ar['PRICE'], 0);
            echo "</td>";
            echo "</td></tr>\n";
    ...
    <footer class="center-text font footer">
        <?php
        include 'footer.php';
        ?>
    </footer>
