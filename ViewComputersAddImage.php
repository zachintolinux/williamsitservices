...
<a href="williamscomputersales.html"><img class="topbar center-logo" src="logo-via-logohub.png" width="304" height="31" alt="logo"></a>
<h3 class="center-text center-title font topbar">Current Inventory</h3>
<div class="center-text">
    ...
    echo "<th style='width: 15px'>MN</th>";
    echo "<th style='width: 15px'>Year</th>";
    echo "<th style='width: 15px'>Brand</th>";
    echo "<th style='width: 30px'>Series</th>";
    echo "<th style='width: 15px'>Color</th>";
    echo "<th style='width: 15px'>Type</th>";
    ...
    while ($result_ar = mysqli_fetch_assoc($result)) {
        ...
        echo "<td><a href='AddImage.php?MN=" . $result_ar['MN'] . "'>Add Image</a> </td>";
        echo "</tr>\n";
